...
checkTuple :: ((a -> Bool), (b -> Bool)) -> (Bool -> Bool -> Bool) -> (a, b) -> Bool
...
supportsTLS = doesSupport . tokens
  where doesSupport = checkTuple (all (not . hasAbba), any hasAbba) (&&)

hasAbba :: String -> Bool
hasAbba = any isAbba . sliding 4

isAbba :: String -> Bool
isAbba (a:b:c:d:[]) = (a == d) && (b == c) && (a /= b)
isAbba _            = False

main = do putStrLn "Number with TLS Support:"
